test_sim <- function(){
  ...
  compile_timedep("custom_rates/test_custom1.cpp")
  # Specify two fixed transitions, birth and death
  transitionList = TransitionList(FixedTransition(population = 0, rate = Rate(3, c("custom_rates/test_custom1.so","rate")), fixed = c(2)),
