...
#' }
simBirth = function(birth = 1.0, init = 100, time = 1){
  transitionList = TransitionList(FixedTransition(population = 0, rate = birth, fixed = c(2)))

  stopList = StopList()

  return(gmbp:::branch(time + 1, init, transitionList, stopList, keep = FALSE, silent = TRUE))
}
...
#' }
simBirthDeath = function(birth = 1.0, death = 0.0, init = 100, time = 1){
  transitionList = TransitionList(FixedTransition(population = 0, rate = birth, fixed = c(2)),
...
#' }
simBirthMutation = function(birth1 = 1.0, mutation = 0.0, birth2 = 1.0, init = c(100,0), time = 1){
...
#' }
simBirthDeathMutation = function(birth1 = 1.0, death1 = 0.0, mutation = 0.0, birth2 = 1.0, death2 = 0.7, init = c(100,0), time = 1){
  transitionList = TransitionList(FixedTransition(population = 0, rate = birth1, fixed = c(2,0)),
