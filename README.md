...
![Example of FIxedTransition(parent = 0 (blue), fixed = c(2, 0)). The blue circles represent indivdiuals of type 0 and the green circles represent individuals of type 1.](README//transition2.png) Figure 1: Example of FIxedTransition(parent = 0 (blue), fixed = c(2, 0)). The blue circles represent indivdiuals of type 0 and the green circles represent individuals of type 1.
